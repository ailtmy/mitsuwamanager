class Newbuild < Project
  ...
  accepts_nested_attributes_for :project_customers,  reject_if: :all_blank, allow_destroy: true
  ...
  accepts_nested_attributes_for :project_estates,  reject_if: :all_blank, allow_destroy: true
