class Room < Estate
  ...
  accepts_nested_attributes_for :apart_room,  reject_if: :all_blank, allow_destroy: true
  ...
  def self.csv_attributes
    %w(id estate_number number apart_name estate_kind structure area type remarks created_at updated_at)
  end
